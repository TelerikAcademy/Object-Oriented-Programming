...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic00.png" style="top:-4%; left:86%; width:14.20%; z-index:-1" /> -->
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic01.png" style="top:60%; left:72%; width:30.27%; z-index:-1" /> -->
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic03.png" style="top:57%; left:32%; width:13.05%; z-index:-1" /> -->
<div class="signature">
...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic41.png" style="top:57%; left:73%; width:21%; z-index:-1" /> -->
