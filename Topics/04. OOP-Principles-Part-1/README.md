...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic08.png" style="top:52%; left:53.88%; width:45.32%; z-index:-1; border-radius: 10px" /> -->
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic09.png" style="top:52%; left:8.04%; width:45.17%; z-index:-1; border-radius: 10px" /> -->
...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic15.png" style="top:13.22%; left:74.50%; width:28.54%; z-index:0; border-radius: 10px" /> -->
...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic16.png" style="top:11.46%; left:81.40%; width:22.04%; z-index:0; border-radius: 10px" /> -->
...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/pic19.png" style="top:52%; left:30%; width:40%; z-index:-1; border-radius: 10px" /> -->
...
<!-- <img showInPresentation="true" class="slide-image" src="imgs/abstraction-example.png" style="top:20%; left:25%; width:60%; z-index:-1; border-radius: 10px" /> -->


<!-- attr: { id:'interfacesId', showInPresentation:true, hasScriptWrapper:true } -->
